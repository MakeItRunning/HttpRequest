...
import com.td.qianhai.epay.bb.adapter.CardListAdapter;
import com.td.qianhai.epay.bb.adapter.ViewPagerAdapter;
...
adapter = new CardListAdapter(PayMainActivity.this, mlist, 0);
adapter1 = new CardListAdapter(PayMainActivity.this, mlist1, 0);
...
protected void onPreExecute() {
	AlertDialog.Builder builder = new Builder(PayMainActivity.this);
...
protected void onPostExecute(HashMap<String, Object> result) {
	...
	if (result != null) {
		if (Entity.STATE_OK.equals(result.get(Entity.RSPCOD))) {
			...
			Intent it = new Intent(PayMainActivity.this,
			...
			ToastCustom.showMessage(PayMainActivity.this,
...
regist_blance.setText(balace);
tv_reblance = (TextView)view2.findViewById(R.id.tv_reblance);
if(balace!=null){
	double b = Double.parseDouble(balace);
...
if(tag!=null&&tag.equals("0")){
	add_creditcard.setVisibility(View.GONE);
	add_creditcard1.setVisibility(View.GONE);
//	delete_propty.setVisibility(View.GONE);
//	delete_propty1.setVisibility(View.GONE);
...
tv_agreement.setOnClickListener(new  OnClickListener() {
	...
	public void onClick(View arg0) {
		...
		Intent intent = new Intent();
		intent.setClass(PayMainActivity.this, OnlineWeb.class);
...
listview.setOnItemClickListener(new OnItemClickListener() {
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
		...
		// TODO Auto-generated method stub
		if(tag!=null&&tag.equals("0")){
			Intent it = new Intent(PayMainActivity.this,CompleteInfoActivity.class);
			it.putExtra("card", mlist.get((int) id).get("CARDCODE").toString());
			startActivity(it);
			return;
		}else if(tag!=null&&tag.equals("1")){
...
//		if(tag!=null&&tag.equals("0")){
//			Intent it = new Intent(PayMainActivity.this,CompleteInfoActivity.class);
//			it.putExtra("card", mlist1.get((int) id).get("CARDCODE").toString());
//			startActivity(it);
//			return;
//		}
		if(tag!=null&&tag.equals("0")){
...
protected void onPostExecute(HashMap<String, Object> result) {
	...
	if (result != null) {
		if (result.get(Entity.RSPCOD).equals(Entity.STATE_OK)) {
			...
			if(iscamera == 1){
				it.setClass(PayMainActivity.this,EpayActivity.class);
			}else if(iscamera == 2){
				it.setClass(PayMainActivity.this,SavpayActivity.class);
			}else{
				it.setClass(PayMainActivity.this,EpayActivity.class);
			}
			it.putExtra("balance", balace);
...
protected void onPostExecute(HashMap<String, Object> result) {
	...
	if (result != null) {
		if (Entity.STATE_OK
			...
			warnDialog = new OneButtonDialogWarn(PayMainActivity.this,
