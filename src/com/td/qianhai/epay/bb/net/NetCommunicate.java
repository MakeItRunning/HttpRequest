package com.td.qianhai.epay.bb.net;
...
import com.td.qianhai.epay.bb.ActCodeBean;
import com.td.qianhai.epay.bb.beans.BankListBean;
import com.td.qianhai.epay.bb.beans.Basis;
import com.td.qianhai.epay.bb.beans.BasisModel;
import com.td.qianhai.epay.bb.beans.CityEntity;
import com.td.qianhai.epay.bb.beans.CreditListBean;
import com.td.qianhai.epay.bb.beans.DealRecordsEntity;
...
import com.td.qianhai.epay.bb.beans.MyAgtBean;
import com.td.qianhai.epay.bb.beans.MyCircleBean;
import com.td.qianhai.epay.bb.beans.OrderPayBean;
import com.td.qianhai.epay.bb.beans.PhoneChargeBean;
import com.td.qianhai.epay.bb.beans.PromotionEarningBean;
import com.td.qianhai.epay.bb.beans.ProvinceEntity;
import com.td.qianhai.epay.bb.beans.RateListBean;
import com.td.qianhai.epay.bb.beans.ReturnActcodeBean;
import com.td.qianhai.epay.bb.beans.RichTreasureBillBean;
import com.td.qianhai.epay.bb.beans.ShareDetailsBean;
import com.td.qianhai.epay.bb.beans.TransactionTypeBean;
...
//			Log.d("result:", EposAesUtil.decryptString(result, "dynamicode"));
	...
	public static ArrayList<HashMap<String, Object>> executeHttpPostnull2(String urlStr, String[] myprofitback,String [] node,String [] values)
			throws ClientProtocolException, IOException, IllegalStateException,
			HttpHostConnectException, Exception {
		for (int i = 0; i < node.length; i++) {
			if (i == 0)
	...
	public static HashMap<String, Object> HttpPostnulls(String urlStr, String[] myprofitback,String [] node,String [] values)
			throws ClientProtocolException, IOException, IllegalStateException,
			HttpHostConnectException, Exception {
		HttpPost httpPost = new HttpPost(urlStr);
		...
		public static ArrayList<HashMap<String, Object>> getListXml(String in,
			...
			while (event != XmlPullParser.END_DOCUMENT) {
				...
				case XmlPullParser.START_TAG:// 判断当前事件是否是标签元素开始事件
					...
					}else if("TOTALPOINT".equals(parser.getName())){
						point = parser.nextText().toString();
					} else if ("TRANDETAIL".equals(parser.getName())) {
						map = new HashMap<String, Object>();
			...
			if(datalist.size()>0){
				...
				datalist.get(0).put("TOTALPOINT",point);
			}
			return datalist;
...
//		}
		...
		public static List<WechatListBean> executeHttpPostgetjson(String urlStr, String[] myprofitback,String [] node,String [] values)
				throws ClientProtocolException, IOException, IllegalStateException,
				HttpHostConnectException, Exception {
			HttpPost httpPost = new HttpPost(urlStr);
			...
			if (httpResponse.getStatusLine().getStatusCode() == 200) {
				String result = EntityUtils.toString(httpResponse.getEntity());
				Log.e("", "result = =  "+result);
				return getjsonlist(result,myprofitback);
