 ...
 * 
 */
public class TwoButtonDialogStylePrompty extends Dialog implements
	...
	public TwoButtonDialogStylePrompty(Context context, boolean cancelable,
			OnCancelListener cancelListener) {
		super(context, cancelable, cancelListener);
		// TODO Auto-generated constructor stub
	}

	public TwoButtonDialogStylePrompty(Context context, int theme, String title, SpannableString content,
	...
	public TwoButtonDialogStylePrompty(Context context, String title, SpannableString content,
			String affirmStr, String cancelStr,
			OnMyDialogClickListener onMyDialogClickListener) {
		super(context);
		// TODO Auto-generated constructor stub
...
//		tv_content.setText(content);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dialog_prompty);
		initView();
	}
