...
import com.td.qianhai.epay.bb.adapter.ActCodeAdapter;
...
//				((AppContext)getApplication()).getAgentid();
	...
	private void initview() {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				// 设置title
				weixinContent.setTitle("贝贝宝激活码:  "+num);
				// 设置分享内容跳转URL
				weixinContent
				...
				// 设置分享title
				qqShareContent.setTitle("贝贝宝激活码:  "+num);
				// 设置分享图片
