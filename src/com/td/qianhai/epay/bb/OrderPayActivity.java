...
import com.td.qianhai.epay.bb.mail.utils.SetPricePoint;
...
import com.td.qianhai.epay.bb.views.dialog.TwoButtonDialogStylePrompty;
...
//				ToastCustom.showMessage(this, "充值金额不能小于1");
		...
		if (balance == null || (balance != null && balance.equals(""))) {
			etBalanceError.setVisibility(View.VISIBLE);
			etBalanceError.setText("请输入收款金额");
			etBalanceError.setError("请输入收款金额");
			etBalance.setVisibility(View.GONE);
			return;
		}
		if (!isNumber(balance)) {
