...
public class HttpKeys {
	...
	public static final String[] LOGIN_ASK = { "TRANCODE", "PHONENUMBER",
			"PASSWORD", "PCSIM", "TERMINALNUMBER", "APPTYP","APPUSERID","APPCHANNELID","CLIENTTYPE","OEMID","JPTAG","JPALIAS","JPREGISTRATIONID","UNIONID","OPENID","HEADIMGURL","NICKNAME"};
	public static final String[] LOGIN_BACK = { "PHONENUMBER", "MERSNM",
			"TERMINALNUMBER", "MERCNUM", "STS","NOCARDFEERATE","IDCARDPICSTA","CUSTPICSTA","FRYHKIMGPATHSTA","CURROL","AGENTID","OEMFEERATE","ISRETAILERS","ISSALEAGT","ISGENERALAGENT","ISSENIORMEMBER","LOEMID","OEMID","PERSONPIC","NCONTENT","NCREATETIM","ISAREAAGENT","NOTICEMESSAGE","UNIONID","OPENID","HEADIMGURL","NICKNAME"};
	...
	public static final String[] RICH_TREASURE_INFO_BACK = { "LOGSTS",
		...
		"INTERESTAMT","LEFTPOINTSTPOINTS","TOTPOINTS","DEPOSITAMT","SALEAGTAMT","LOWWDAMT","ISBRUSHOTHERSCARD","FEEOFPOINT","EXTENDCOUNT","EXTENDCOUNTBASE","FEEOFPRESTORE","POINT","RSPCOD", "RSPMSG" };
	// 修改支付密码
	...
	public static final String[] REGISTER_ASK = { "PHONENUMBER", "PASSWORD",
			"EMAIL", "MERMOD", "RANDOM", "TRMTYP" ,"APPMARKNUMBER","RECOMMENDATION","ACTCODE","OPENID","UNIONID"};
	...
	public static final String[] BUSSINESS_INFO_BACK = { "PHONENUMBER",
		"ACTNAM", "ACTNO", "OPNBNK", "CARDID", "MERSTATUS", "MERCNUM" ,"ISRECOMMENDED","RECOMMENDED","PROVNAM","CITYNAM","MERLEVEL","FEERAT","SALEFEERATE","VIPFEERATE","STRATE","AREANAM","AGTPROVNAM","AGTCITYNAM","AGTAREANAM","ISAREAAGENT","AUTHENTICATIONNUM","OPENID","UNIONID","NICKNAME","HEADIMGURL"};
	...
	public static final String[] VERSION_UPDATE_BACK = { "VERCODE", "VERNAME",
			"APKNAME", "CREATETIM", "APKNOTE","APKRUL", "ISFORCE" };
...
//	public static final String[] RECHARGE_ASK = {"TRANCODE","PHONENUMBER"};
	...
	public static final String[] ORDERINFO_BACK = { "ACTID", "ACTNAM",
			...
			"FEEAMT", "OPERTIM", "REMARK", "OPERSTS","TARGCARDNO","TARGATCNAM","RECNUMBER","CARDNO","CARDNAM","BANKNAM","OUTACTID","OUTACTNAM"};
	...
	public static final String[] APPLYCODE_BACK = {"ACTIVENUM","MAKENUM","UNMAKENUM","ALLOTNUM","RSPCOD","RSPMSG"};
	
	public static final String[] RECOMMENDEDLIST_ASK = {"TRANCODE","MERCNUM","PAGENUM","NUMPERPAG"};
	public static final String[] RECOMMENDEDLIST_BACK = {"OPTTYPE","AMT","CREATETIME","RSPCOD","RSPMSG"};
	
	public static final String[] POINTLIST_ASK = {"TRANCODE","MERCNUM","PAGENUM","NUMPERPAG"};
	public static final String[] POINTLIST_BACK = {"POINT","TXTIME","TOLCNT","TOTALPOINT","RSPCOD","RSPMSG"};
	
	public static final String[] BINDPHONENUM_ASK = {"TRANCODE","PHONENUMBER","PASSWORD","OPENID","UNIONID"};
	public static final String[] BINDPHONENUM_BACK = {"RSPCOD","RSPMSG"};
	
	public static final String[] SYNCFRIEND_ASK = {"MERCNUM","MOBILES"};
	public static final String[] SYNCFRIEND_BACK = {"RSPCOD","RSPMSG"};
...
//			return YIBAO_ASK;
		...
		case HttpUrls.APPLYCODE:
			return APPLYCODE_ASK;
			
		case HttpUrls.RECOMMENDEDLIST:
			return RECOMMENDEDLIST_ASK;
			
		case HttpUrls.POINTLIST:
			return POINTLIST_ASK;
			
		case HttpUrls.BINDPHONENUM:
